...
Medusa.LangFr = {
    ...
    Settings_General_Height = "Hauteur",
    Settings_General_Height_Tooltip = "Hauteur de la barre",
    Settings_General_Color = "Couleur",
    Settings_General_Color_Tooltip = "Changer la couleur de la barre",
    ...
    Settings_Cloudrest_Kite_Show = "Montre la barre de kite",
    Settings_Cloudrest_Kite_Show_Tooltip = "Quand ON, la barre de kite afficher à l'écran pourra être ajusté et déplacer",
}
